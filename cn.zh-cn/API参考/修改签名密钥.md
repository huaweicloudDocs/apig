# 修改签名密钥<a name="ZH-CN_TOPIC_0000001111702152"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=APIG&api=UpdateSignatureKeyV2)中调试该接口。

## URI

PUT /v2/\{project\_id\}/apigw/instances/\{instance\_id\}/signs/\{sign\_id\}
