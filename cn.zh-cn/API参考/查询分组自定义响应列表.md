# 查询分组自定义响应列表<a name="ZH-CN_TOPIC_0000001111702192"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=APIG&api=ListGatewayResponsesV2)中调试该接口。

## URI

GET /v2/\{project\_id\}/apigw/instances/\{instance\_id\}/api-groups/\{group\_id\}/gateway-responses
...
<a name="response_ResponsesInfoPage"></a>
...
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.4.1.2 "><p>Array of <a href="#response_ResponseInfoResp">ResponseInfoResp</a> objects</p>
</td>
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p>响应列表</p>
</td>
</tr>
</tbody>
</table>
