# 批量解除API与ACL策略的绑定<a name="apig-api-190111262"></a>
...
<td class="cellrowborder" valign="top" width="65.66%" headers="mcps1.2.3.1.2 "><p id="p55006047"><a name="p55006047"></a><a name="p55006047"></a>/v1.0/apigw/acl-bindings[?action]</p>
</td>
</tr>
</tbody>
</table>
