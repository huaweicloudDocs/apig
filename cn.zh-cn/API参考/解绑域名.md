# 解绑域名<a name="ZH-CN_TOPIC_0000001111862068"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=APIG&api=DisassociateDomainV2)中调试该接口。

## URI

DELETE /v2/\{project\_id\}/apigw/instances/\{instance\_id\}/api-groups/\{group\_id\}/domains/\{domain\_id\}
