# 查询API历史版本列表<a name="apig-phapi-180713033"></a>
...
<td class="cellrowborder" valign="top" width="80%" headers="mcps1.2.3.1.2 "><p id="p88529"><a name="p88529"></a><a name="p88529"></a><span id="ph39713251412"><a name="ph39713251412"></a><a name="ph39713251412"></a>/v1/{project_id}/apigw/instances/{instance_id}</span>/apis/publish/{api_id}[?env_id,env_name]</p>
</td>
</tr>
</tbody>
</table>
