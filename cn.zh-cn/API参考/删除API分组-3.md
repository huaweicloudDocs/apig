# 删除API分组<a name="apig-phapi-180713018"></a>
...
<td class="cellrowborder" valign="top" width="80%" headers="mcps1.2.3.1.2 "><p id="p25125550"><a name="p25125550"></a><a name="p25125550"></a>/v1/{project_id}/apigw/instances/{instance_id}/api-groups/{id}</p>
</td>
</tr>
</tbody>
</table>
