...
<td class="cellrowborder" valign="top" width="80%" headers="mcps1.2.3.1.2 "><p id="p63919982"><a name="p63919982"></a><a name="p63919982"></a><span id="ph11580141014416"><a name="ph11580141014416"></a><a name="ph11580141014416"></a>/v1/{project_id}/apigw/instances/{instance_id}</span>/throttles/{id}</p>
</td>
</tr>
</tbody>
</table>
