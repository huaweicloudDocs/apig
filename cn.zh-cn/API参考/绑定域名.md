# 绑定域名<a name="apig-zh-api-180713154"></a>

## 功能介绍<a name="section173482301428"></a>

用户自定义的域名，需要CNAME到API分组的子域名上才能生效，具体方法请参见[新增记录集](https://support.huaweicloud.com/usermanual-dns/zh-cn_topic_0035467703.html)。
...
<td class="cellrowborder" valign="top" width="80%" headers="mcps1.2.3.1.2 "><p id="p11361848184318"><a name="p11361848184318"></a><a name="p11361848184318"></a>/v1.0/apigw/api-groups/{group_id}/domains</p>
</td>
</tr>
</tbody>
</table>
