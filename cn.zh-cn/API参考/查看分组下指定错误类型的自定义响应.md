# 查看分组下指定错误类型的自定义响应<a name="ZH-CN_TOPIC_0000001111862086"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=APIG&api=ShowDetailsOfGatewayResponseTypeV2)中调试该接口。

## URI

GET /v2/\{project\_id\}/apigw/instances/\{instance\_id\}/api-groups/\{group\_id\}/gateway-responses/\{response\_id\}/\{response\_type\}
