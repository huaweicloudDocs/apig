# 查询流控策略列表<a name="ZH-CN_TOPIC_0000001158661985"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=APIG&api=ListRequestThrottlingPolicyV2)中调试该接口。

## URI

GET /v2/\{project\_id\}/apigw/instances/\{instance\_id\}/throttles
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>流控策略名称</p>
</td>
</tr>
...
<a name="response_ThrottleListResp"></a>
...
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.4.1.2 "><p>Array of <a href="#response_ThrottleResp">ThrottleResp</a> objects</p>
</td>
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p>本次查询到的流控策略列表</p>
</td>
</tr>
</tbody>
</table>
