# 删除特殊设置<a name="ZH-CN_TOPIC_0000001111702160"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=APIG&api=DeleteSpecialThrottlingConfigurationV2)中调试该接口。

## URI

DELETE /v2/\{project\_id\}/apigw/instances/\{instance\_id\}/throttles/\{throttle\_id\}/throttle-specials/\{strategy\_id\}
