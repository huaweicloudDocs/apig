# 删除流控策略<a name="ZH-CN_TOPIC_0000001158501995"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=APIG&api=DeleteRequestThrottlingPolicyV2)中调试该接口。

## URI

DELETE /v2/\{project\_id\}/apigw/instances/\{instance\_id\}/throttles/\{throttle\_id\}
