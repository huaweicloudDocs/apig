# 根据版本编号下线API<a name="ZH-CN_TOPIC_0000001111862046"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=APIG&api=DeleteApiByVersionIdV2)中调试该接口。

## URI

DELETE /v2/\{project\_id\}/apigw/instances/\{instance\_id\}/apis/versions/\{version\_id\}
