# 查看签名密钥未绑定的API列表<a name="ZH-CN_TOPIC_0000001158502007"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=APIG&api=ListApisNotBoundWithSignatureKeyV2)中调试该接口。

## URI

GET /v2/\{project\_id\}/apigw/instances/\{instance\_id\}/sign-bindings/unbinded-apis
...
<a name="response_SignUnbindingApiListResp"></a>
...
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.4.1.2 "><p>Array of <a href="#response_SignUnbindingApiResp">SignUnbindingApiResp</a> objects</p>
</td>
...
**表 5**  SignUnbindingApiResp

<a name="response_SignUnbindingApiResp"></a>
<table><thead align="left"><tr><th class="cellrowborder" valign="top" width="20%" id="mcps1.2.4.1.1"><p>参数</p>
</th>
<th class="cellrowborder" valign="top" width="20%" id="mcps1.2.4.1.2"><p>参数类型</p>
</th>
...
<tr><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.4.1.1 "><p>signature_name</p>
</td>
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.4.1.2 "><p>String</p>
</td>
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p>已绑定的签名密钥名称</p>
</td>
</tr>
