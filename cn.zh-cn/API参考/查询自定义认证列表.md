# 查询自定义认证列表<a name="ZH-CN_TOPIC_0000001111702182"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=APIG&api=ListCustomAuthorizersV2)中调试该接口。

## URI

GET /v2/\{project\_id\}/apigw/instances/\{instance\_id\}/authorizers
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>编号</p>
</td>
</tr>
...
<a name="response_AuthorizerPageResp"></a>
...
<tr><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.4.1.1 "><p>authorizer_list</p>
</td>
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.4.1.2 "><p>Array of <a href="#response_AuthorizerResp">AuthorizerResp</a> objects</p>
</td>
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p>自定义认证列表</p>
</td>
</tr>
</tbody>
</table>
