# 导入API到已有分组<a name="apig-phapi-190108258"></a>
...
<td class="cellrowborder" valign="top" width="79.43%" headers="mcps1.2.3.1.2 "><p id="p19454226101515"><a name="p19454226101515"></a><a name="p19454226101515"></a>/v1/{project_id}/apigw/instances/{instance_id}/openapi?group_id={0}&amp;mode={1}</p>
</td>
</tr>
</tbody>
</table>
