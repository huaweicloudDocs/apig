# 查看ACL策略详情<a name="ZH-CN_TOPIC_0000001111702176"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=APIG&api=ShowDetailsOfAclPolicyV2)中调试该接口。

## URI

GET /v2/\{project\_id\}/apigw/instances/\{instance\_id\}/acls/\{acl\_id\}
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>ACL策略的编号</p>
</td>
</tr>
</tbody>
</table>
