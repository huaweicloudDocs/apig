# 关闭实例公网出口<a name="ZH-CN_TOPIC_0000001158502051"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=APIG&api=RemoveEngressEipV2)中调试该接口。

## URI

DELETE /v2/\{project\_id\}/apigw/instances/\{instance\_id\}/nat-eip
