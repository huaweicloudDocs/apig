# 修改API<a name="ZH-CN_TOPIC_0000001158501997"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=APIG&api=UpdateApiV2)中调试该接口。

## URI

PUT /v2/\{project\_id\}/apigw/instances/\{instance\_id\}/apis/\{api\_id\}
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>API的编号，可通过查询API信息获取该编号。</p>
</td>
</tr>
</tbody>
</table>
