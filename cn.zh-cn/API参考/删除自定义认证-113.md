...
<td class="cellrowborder" valign="top" width="80%" headers="mcps1.2.3.1.2 "><p id="p49426402"><a name="p49426402"></a><a name="p49426402"></a><span id="ph3172115513473"><a name="ph3172115513473"></a><a name="ph3172115513473"></a>/v1/{project_id}/apigw/instances/{instance_id}</span>/authorizers/{id}</p>
</td>
</tr>
</tbody>
</table>
