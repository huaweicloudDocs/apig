# 解除API与流控策略的绑定关系<a name="ZH-CN_TOPIC_0000001111862052"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=APIG&api=DisassociateRequestThrottlingPolicyV2)中调试该接口。

## URI

DELETE /v2/\{project\_id\}/apigw/instances/\{instance\_id\}/throttle-bindings/\{throttle\_binding\_id\}
...
<tr><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.5.1.1 "><p>throttle_binding_id</p>
</td>
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.5.1.2 "><p>是</p>
</td>
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.5.1.3 "><p>String</p>
</td>
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>API和流控策略绑定关系的ID。</p>
</td>
</tr>
</tbody>
</table>
