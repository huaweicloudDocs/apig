...
<td class="cellrowborder" valign="top" width="80%" headers="mcps1.2.3.1.2 "><p id="p1213518364578"><a name="p1213518364578"></a><a name="p1213518364578"></a>/v1/{project_id}/apigw/instances/{instance_id}/openapi?env_id={0}&amp;group_id={1}&amp;define={2}&amp;version={3}&amp;type={4}</p>
</td>
</tr>
</tbody>
</table>
