# 查询分组列表<a name="ZH-CN_TOPIC_0000001158661979"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=APIG&api=ListApiGroupsV2)中调试该接口。

## URI

GET /v2/\{project\_id\}/apigw/instances/\{instance\_id\}/api-groups
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>指定需要精确匹配查找的参数名称，目前仅支持API分组名称</p>
</td>
</tr>
</tbody>
</table>
...
<a name="response_ApiGroupListResp"></a>
...
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.4.1.2 "><p>Array of <a href="#response_ApiGroupDetailResp">ApiGroupDetailResp</a> objects</p>
</td>
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p>分组列表</p>
</td>
</tr>
</tbody>
</table>

**表 5**  ApiGroupDetailResp
