# 查询版本列表（函数工作流专用）<a name="apig-phapi-180911218"></a>

## 功能介绍<a name="section56312882"></a>

查询API的版本列表。

该接口会解析列表中的每一个版本详情，速度较慢，消耗较大，建议不要频繁调用。
...
<td class="cellrowborder" valign="top" width="80%" headers="mcps1.2.3.1.2 "><p id="p18327454"><a name="p18327454"></a><a name="p18327454"></a>/v1/{project_id}/apigw/instances/{instance_id}/apis/versions[?page_size, page_no, func_urn, api_id, env_id, group_id, project_id]</p>
</td>
</tr>
</tbody>
</table>
...
>-   查询条件可为以下字段以及对应的值：func\_urn、api\_id、env\_id、group\_id、project\_id、page\_size、page\_no。  
...
<th class="cellrowborder" valign="top" width="16.07%" id="mcps1.2.5.1.2"><p id="p39220237"><a name="p39220237"></a><a name="p39220237"></a>是否必选</p>
</th>
<th class="cellrowborder" valign="top" width="18.509999999999998%" id="mcps1.2.5.1.3"><p id="p22722661"><a name="p22722661"></a><a name="p22722661"></a>类型</p>
</th>
<th class="cellrowborder" valign="top" width="40.42%" id="mcps1.2.5.1.4"><p id="p28596237"><a name="p28596237"></a><a name="p28596237"></a>说明</p>
</th>
</tr>
</thead>
<tbody><tr id="row6157101216202"><td class="cellrowborder" valign="top" width="25%" headers="mcps1.2.5.1.1 "><p id="p55878963"><a name="p55878963"></a><a name="p55878963"></a>project_id</p>
</td>
...
<td class="cellrowborder" valign="top" width="40.42%" headers="mcps1.2.5.1.4 "><p id="p28867016"><a name="p28867016"></a><a name="p28867016"></a>项目ID。可从控制台“我的凭证”中获取region下项目ID，管理员权限可查询。</p>
</td>
</tr>
<tr id="row39628111208"><td class="cellrowborder" valign="top" width="25%" headers="mcps1.2.5.1.1 "><p id="p1780913159538"><a name="p1780913159538"></a><a name="p1780913159538"></a>instance_id</p>
</td>
...
<td class="cellrowborder" valign="top" width="40.42%" headers="mcps1.2.5.1.4 "><p id="p1880914157537"><a name="p1880914157537"></a><a name="p1880914157537"></a>实例ID，可从API网关控制台的专享版实例信息中获取。</p>
</td>
</tr>
<tr id="row5446846181114"><td class="cellrowborder" valign="top" width="25%" headers="mcps1.2.5.1.1 "><p id="p2446194681119"><a name="p2446194681119"></a><a name="p2446194681119"></a>func_urn</p>
</td>
<td class="cellrowborder" valign="top" width="16.07%" headers="mcps1.2.5.1.2 "><p id="p1744615463119"><a name="p1744615463119"></a><a name="p1744615463119"></a>是</p>
</td>
<td class="cellrowborder" valign="top" width="18.509999999999998%" headers="mcps1.2.5.1.3 "><p id="p1044644681119"><a name="p1044644681119"></a><a name="p1044644681119"></a>String</p>
</td>
<td class="cellrowborder" valign="top" width="40.42%" headers="mcps1.2.5.1.4 "><p id="p244674617115"><a name="p244674617115"></a><a name="p244674617115"></a>函数URN</p>
</td>
</tr>
<tr id="row11400145510112"><td class="cellrowborder" valign="top" width="25%" headers="mcps1.2.5.1.1 "><p id="p740005513117"><a name="p740005513117"></a><a name="p740005513117"></a>api_id</p>
</td>
<td class="cellrowborder" valign="top" width="16.07%" headers="mcps1.2.5.1.2 "><p id="p740065516115"><a name="p740065516115"></a><a name="p740065516115"></a>否</p>
</td>
<td class="cellrowborder" valign="top" width="18.509999999999998%" headers="mcps1.2.5.1.3 "><p id="p64001255171112"><a name="p64001255171112"></a><a name="p64001255171112"></a>String</p>
</td>
<td class="cellrowborder" valign="top" width="40.42%" headers="mcps1.2.5.1.4 "><p id="p440065541114"><a name="p440065541114"></a><a name="p440065541114"></a>API编号</p>
</td>
</tr>
<tr id="row108221157121112"><td class="cellrowborder" valign="top" width="25%" headers="mcps1.2.5.1.1 "><p id="p3822205721111"><a name="p3822205721111"></a><a name="p3822205721111"></a>env_id</p>
</td>
<td class="cellrowborder" valign="top" width="16.07%" headers="mcps1.2.5.1.2 "><p id="p9822557131112"><a name="p9822557131112"></a><a name="p9822557131112"></a>否</p>
</td>
<td class="cellrowborder" valign="top" width="18.509999999999998%" headers="mcps1.2.5.1.3 "><p id="p198222574119"><a name="p198222574119"></a><a name="p198222574119"></a>String</p>
</td>
<td class="cellrowborder" valign="top" width="40.42%" headers="mcps1.2.5.1.4 "><p id="p19822457121116"><a name="p19822457121116"></a><a name="p19822457121116"></a>环境编号</p>
</td>
</tr>
<tr id="row133061453201110"><td class="cellrowborder" valign="top" width="25%" headers="mcps1.2.5.1.1 "><p id="p6306153141115"><a name="p6306153141115"></a><a name="p6306153141115"></a>group_id</p>
</td>
<td class="cellrowborder" valign="top" width="16.07%" headers="mcps1.2.5.1.2 "><p id="p17306105319115"><a name="p17306105319115"></a><a name="p17306105319115"></a>否</p>
</td>
<td class="cellrowborder" valign="top" width="18.509999999999998%" headers="mcps1.2.5.1.3 "><p id="p1130611536115"><a name="p1130611536115"></a><a name="p1130611536115"></a>String</p>
</td>
<td class="cellrowborder" valign="top" width="40.42%" headers="mcps1.2.5.1.4 "><p id="p1230625310112"><a name="p1230625310112"></a><a name="p1230625310112"></a>分组编号</p>
</td>
</tr>
<tr id="row11180251201113"><td class="cellrowborder" valign="top" width="25%" headers="mcps1.2.5.1.1 "><p id="p118015110119"><a name="p118015110119"></a><a name="p118015110119"></a>project_id</p>
</td>
<td class="cellrowborder" valign="top" width="16.07%" headers="mcps1.2.5.1.2 "><p id="p7180051151118"><a name="p7180051151118"></a><a name="p7180051151118"></a>否</p>
</td>
<td class="cellrowborder" valign="top" width="18.509999999999998%" headers="mcps1.2.5.1.3 "><p id="p14180851181113"><a name="p14180851181113"></a><a name="p14180851181113"></a>String</p>
</td>
<td class="cellrowborder" valign="top" width="40.42%" headers="mcps1.2.5.1.4 "><p id="p13180145191120"><a name="p13180145191120"></a><a name="p13180145191120"></a>租户编号</p>
</td>
</tr>
<tr id="row15180174910118"><td class="cellrowborder" valign="top" width="25%" headers="mcps1.2.5.1.1 "><p id="p36230260"><a name="p36230260"></a><a name="p36230260"></a>page_size</p>
</td>
<td class="cellrowborder" valign="top" width="16.07%" headers="mcps1.2.5.1.2 "><p id="p48969944"><a name="p48969944"></a><a name="p48969944"></a>否</p>
</td>
<td class="cellrowborder" valign="top" width="18.509999999999998%" headers="mcps1.2.5.1.3 "><p id="p7142557"><a name="p7142557"></a><a name="p7142557"></a>Integer</p>
</td>
<td class="cellrowborder" valign="top" width="40.42%" headers="mcps1.2.5.1.4 "><p id="p41676267"><a name="p41676267"></a><a name="p41676267"></a>每页显示的条数，默认值：20</p>
</td>
</tr>
<tr id="row34593837"><td class="cellrowborder" valign="top" width="25%" headers="mcps1.2.5.1.1 "><p id="p48792241"><a name="p48792241"></a><a name="p48792241"></a>page_no</p>
</td>
<td class="cellrowborder" valign="top" width="16.07%" headers="mcps1.2.5.1.2 "><p id="p59857467"><a name="p59857467"></a><a name="p59857467"></a>否</p>
</td>
<td class="cellrowborder" valign="top" width="18.509999999999998%" headers="mcps1.2.5.1.3 "><p id="p16616649"><a name="p16616649"></a><a name="p16616649"></a>Integer</p>
</td>
<td class="cellrowborder" valign="top" width="40.42%" headers="mcps1.2.5.1.4 "><p id="p3771332"><a name="p3771332"></a><a name="p3771332"></a>页码，默认值：1</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p id="p23321404"><a name="p23321404"></a><a name="p23321404"></a>本次查询到的API版本列表</p>
</td>
</tr>
</tbody>
</table>
...
<tr id="row8541655381"><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.4.1.1 "><p id="p4426105522114"><a name="p4426105522114"></a><a name="p4426105522114"></a>authorizer_id</p>
</td>
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.4.1.2 "><p id="p157029116385"><a name="p157029116385"></a><a name="p157029116385"></a>String</p>
</td>
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p id="p125418520388"><a name="p125418520388"></a><a name="p125418520388"></a>前端自定义认证对象的ID</p>
</td>
</tr>
...
<tr id="row5700125144614"><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.4.1.1 "><p id="p5689175210267"><a name="p5689175210267"></a><a name="p5689175210267"></a>tags</p>
</td>
...
<tr id="row1975128123814"><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.4.1.1 "><p id="p16517163113815"><a name="p16517163113815"></a><a name="p16517163113815"></a>authorizer_id</p>
</td>
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.4.1.2 "><p id="p105861433183811"><a name="p105861433183811"></a><a name="p105861433183811"></a>String</p>
</td>
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p id="p116491557133012"><a name="p116491557133012"></a><a name="p116491557133012"></a>后端自定义认证对象的ID</p>
</td>
</tr>
</tbody>
</table>
