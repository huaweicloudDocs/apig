# 删除分组指定错误类型的自定义响应配置<a name="ZH-CN_TOPIC_0000001158662033"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=APIG&api=DeleteGatewayResponseTypeV2)中调试该接口。

## URI

DELETE /v2/\{project\_id\}/apigw/instances/\{instance\_id\}/api-groups/\{group\_id\}/gateway-responses/\{response\_id\}/\{response\_type\}
