# 删除签名密钥<a name="ZH-CN_TOPIC_0000001111862048"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=APIG&api=DeleteSignatureKeyV2)中调试该接口。

## URI

DELETE /v2/\{project\_id\}/apigw/instances/\{instance\_id\}/signs/\{sign\_id\}
