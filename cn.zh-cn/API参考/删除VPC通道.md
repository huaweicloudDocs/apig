# 删除VPC通道<a name="ZH-CN_TOPIC_0000001111862080"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=APIG&api=DeleteVpcChannelV2)中调试该接口。

## URI

DELETE /v2/\{project\_id\}/apigw/instances/\{instance\_id\}/vpc-channels/\{vpc\_channel\_id\}
