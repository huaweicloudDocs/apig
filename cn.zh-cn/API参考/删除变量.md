# 删除变量<a name="ZH-CN_TOPIC_0000001111862036"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=APIG&api=DeleteEnvironmentVariableV2)中调试该接口。

## URI

DELETE /v2/\{project\_id\}/apigw/instances/\{instance\_id\}/env-variables/\{env\_variable\_id\}
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>环境变量的ID</p>
</td>
</tr>
</tbody>
</table>
