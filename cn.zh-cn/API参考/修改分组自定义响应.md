# 修改分组自定义响应<a name="ZH-CN_TOPIC_0000001158662031"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=APIG&api=UpdateGatewayResponseV2)中调试该接口。

## URI

PUT /v2/\{project\_id\}/apigw/instances/\{instance\_id\}/api-groups/\{group\_id\}/gateway-responses/\{response\_id\}
