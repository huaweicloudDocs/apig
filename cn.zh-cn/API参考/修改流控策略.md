# 修改流控策略<a name="ZH-CN_TOPIC_0000001111862038"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=APIG&api=UpdateRequestThrottlingPolicyV2)中调试该接口。

## URI

PUT /v2/\{project\_id\}/apigw/instances/\{instance\_id\}/throttles/\{throttle\_id\}
