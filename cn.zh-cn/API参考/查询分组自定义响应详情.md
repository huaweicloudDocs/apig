# 查询分组自定义响应详情<a name="ZH-CN_TOPIC_0000001158502041"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=APIG&api=ShowDetailsOfGatewayResponseV2)中调试该接口。

## URI

GET /v2/\{project\_id\}/apigw/instances/\{instance\_id\}/api-groups/\{group\_id\}/gateway-responses/\{response\_id\}
