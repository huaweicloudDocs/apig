# 发布或下线API<a name="ZH-CN_TOPIC_0000001111702146"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=APIG&api=CreateOrDeletePublishRecordForApiV2)中调试该接口。

## URI

POST /v2/\{project\_id\}/apigw/instances/\{instance\_id\}/apis/action
...
<a name="request_ApiPublishReq"></a>
<table><thead align="left"><tr><th class="cellrowborder" valign="top" width="20%" id="mcps1.2.5.1.1"><p>参数</p>
</th>
<th class="cellrowborder" valign="top" width="20%" id="mcps1.2.5.1.2"><p>是否必选</p>
</th>
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>需要进行的操作。</p>
<ul><li><p>online：发布</p>
</li><li><p>offline：下线</p>
</li></ul>
<p>枚举值：</p>
<ul><li><p><strong>online</strong></p>
</li><li><p><strong>offline</strong></p>
</li></ul>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>环境的编号，即：API需要发布到哪个环境</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>API的编号，即：需要进行发布或下线的API的编号</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>对发布动作的简述。字符长度不超过255</p>
...
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p>在线的版本号</p>
</td>
</tr>
</tbody>
</table>
