# 删除后端实例（弹性云服务器）<a name="apig-zh-api-180713167"></a>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.3.1.2 "><p id="p11361848184318"><a name="p11361848184318"></a><a name="p11361848184318"></a>/v1.0/apigw/vpc-channels/{id}/members/{inst_id}</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="42.85571442855714%" headers="mcps1.2.5.1.4 "><p id="p1879575812612"><a name="p1879575812612"></a><a name="p1879575812612"></a>member对象的编号。</p>
</td>
</tr>
</tbody>
</table>
