# 修改环境<a name="ZH-CN_TOPIC_0000001111862034"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=APIG&api=UpdateEnvironmentV2)中调试该接口。

## URI

PUT /v2/\{project\_id\}/apigw/instances/\{instance\_id\}/envs/\{env\_id\}
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>环境的ID，可通过查询环境信息获取该ID</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>环境的名称，支持英文，数字，下划线，且只能以英文字母开头。</p>
