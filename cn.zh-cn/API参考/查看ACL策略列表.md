# 查看ACL策略列表<a name="ZH-CN_TOPIC_0000001111862072"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=APIG&api=ListAclStrategiesV2)中调试该接口。

## URI

GET /v2/\{project\_id\}/apigw/instances/\{instance\_id\}/acls
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>作用的对象类型：</p>
<ul><li><p>IP</p>
</li><li><p>DOMAIN</p>
</li></ul>
</td>
...
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.4.1.2 "><p>Array of <a href="#response_ApiAclInfoWithBindNum">ApiAclInfoWithBindNum</a> objects</p>
</td>
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p>本次查询返回的ACL策略列表</p>
</td>
</tr>
</tbody>
</table>

**表 5**  ApiAclInfoWithBindNum

<a name="response_ApiAclInfoWithBindNum"></a>
<table><thead align="left"><tr><th class="cellrowborder" valign="top" width="20%" id="mcps1.2.4.1.1"><p>参数</p>
</th>
<th class="cellrowborder" valign="top" width="20%" id="mcps1.2.4.1.2"><p>参数类型</p>
</th>
...
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p>ACL策略的值</p>
</td>
</tr>
