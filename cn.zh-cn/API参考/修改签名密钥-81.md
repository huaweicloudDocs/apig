...
<td class="cellrowborder" valign="top" width="80%" headers="mcps1.2.3.1.2 "><p id="p28545370"><a name="p28545370"></a><a name="p28545370"></a><span id="ph28916139458"><a name="ph28916139458"></a><a name="ph28916139458"></a>/v1/{project_id}/apigw/instances/{instance_id}</span>/signs/{id}</p>
</td>
</tr>
</tbody>
</table>
