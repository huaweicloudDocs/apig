# 删除域名证书<a name="ZH-CN_TOPIC_0000001158502025"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=APIG&api=DisassociateCertificateV2)中调试该接口。

## URI

DELETE /v2/\{project\_id\}/apigw/instances/\{instance\_id\}/api-groups/\{group\_id\}/domains/\{domain\_id\}/certificate/\{certificate\_id\}
