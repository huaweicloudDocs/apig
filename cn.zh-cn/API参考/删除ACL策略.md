# 删除ACL策略<a name="ZH-CN_TOPIC_0000001158502027"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=APIG&api=DeleteAclV2)中调试该接口。

## URI

DELETE /v2/\{project\_id\}/apigw/instances/\{instance\_id\}/acls/\{acl\_id\}
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>需要删除的ACL ID</p>
</td>
</tr>
</tbody>
</table>
