# 删除自定义认证<a name="ZH-CN_TOPIC_0000001158502033"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=APIG&api=DeleteCustomAuthorizerV2)中调试该接口。

## URI

DELETE /v2/\{project\_id\}/apigw/instances/\{instance\_id\}/authorizers/\{authorizer\_id\}
