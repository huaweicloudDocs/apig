# 创建OPTIONS方式的API<a name="apig-zh-ug-180621094"></a>

## 操作场景<a name="section4753204453810"></a>

当开启CORS（非简单请求）时，您需要单独创建一个“Method”为“OPTIONS”的API。

## 前提条件<a name="section4182193174418"></a>

已创建一个API，且此API已开启CORS（非简单请求）。

## 操作步骤<a name="section18694939204412"></a>
...
5.  单击“新建API”，进入“新建API”页面，填写如[表1](#table195413315428)所示信息。
    ...
    **表 1**  基本信息
    ...
    <td class="cellrowborder" valign="top" width="42%" headers="mcps1.2.4.1.3 "><p id="p8880154374314"><a name="p8880154374314"></a><a name="p8880154374314"></a>选择已开启CORS的API所在的分组。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="42%" headers="mcps1.2.4.1.3 "><p id="p19611248142514"><a name="p19611248142514"></a><a name="p19611248142514"></a>无论选择哪种认证方式，都不支持认证。</p>
    </td>
    </tr>
...
6.  单击“下一步”，进入“定义API请求”页面，填写如[表2](#table197931223191513)所示信息。
    ...
    **表 2**  定义API请求
    ...
    <td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.4.1.2 "><p id="p56583574195"><a name="p56583574195"></a><a name="p56583574195"></a>分为两种类型：</p>
    <a name="ul1117910143194"></a><a name="ul1117910143194"></a><ul id="ul1117910143194"><li>HTTP</li><li>HTTPS</li></ul>
    </td>
    <td class="cellrowborder" valign="top" width="42%" headers="mcps1.2.4.1.3 "><p id="p1179462313159"><a name="p1179462313159"></a><a name="p1179462313159"></a>选择与已开启CORS的API相同的请求协议。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="42%" headers="mcps1.2.4.1.3 "><p id="p1177798164019"><a name="p1177798164019"></a><a name="p1177798164019"></a>选择与已开启CORS的API相同的请求Path或者与已开启CORS的API匹配的请求Path。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="42%" headers="mcps1.2.4.1.3 "><a name="ul134522715211"></a><a name="ul134522715211"></a><ul id="ul134522715211"><li>选择绝对匹配，则调用的请求Path固定为创建时填写的API请求Path。</li><li>选择前缀匹配，则调用的请求Path将以创建时填写的API请求Path为前缀，支持接口定义多个不同Path。<div class="p" id="p1239819294527"><a name="p1239819294527"></a><a name="p1239819294527"></a>例如，请求路径为/test/AA，使用前缀匹配时，通过/test/AA/CC可以访问，但是通过/test/AACC无法访问。<div class="note" id="note4911427135214"><a name="note4911427135214"></a><a name="note4911427135214"></a><span class="notetitle"> 说明： </span><div class="notebody"><a name="ul6338114175914"></a><a name="ul6338114175914"></a><ul id="ul6338114175914"><li>前缀匹配不支持“+”字符。</li><li>同一个API分组内有多个开启CORS的API时，采用前缀匹配，此时开启CORS的API都可以使用同一个OPTION方式的API作为HTTP查询请求。</li></ul>
    </div></div>
    </div>
    </li></ul>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.4.1.2 "><p id="p67943234152"><a name="p67943234152"></a><a name="p67943234152"></a>接口调用方式：OPTIONS</p>
    </td>
    <td class="cellrowborder" valign="top" width="42%" headers="mcps1.2.4.1.3 "><p id="p87941823111514"><a name="p87941823111514"></a><a name="p87941823111514"></a>-</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="42%" headers="mcps1.2.4.1.3 "><p id="p11501418111810"><a name="p11501418111810"></a><a name="p11501418111810"></a>选择开启CORS。</p>
    </td>
    </tr>
    </tbody>
    </table>
...
11. 单击“下一步”，进入“返回结果基础定义”页面，填写如[表6](#zh-cn_topic_0080101678_table744813380582)所示信息。
