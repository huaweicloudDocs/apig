...
10. 单击“下一步”，进入“定义后端服务”页面，编辑如[表4](#table19365277271)所示信息。
    ...
    **表 4**  定义后端服务
    ...
    <td class="cellrowborder" valign="top" headers="mcps1.2.4.1.2 "><p id="p199133710713"><a name="p199133710713"></a><a name="p199133710713"></a>IP地址:端口/域名。仅在不使用VPC通道时，需要设置。</p>
    <p id="p1305171710298"><a name="p1305171710298"></a><a name="p1305171710298"></a>端口范围：1 ~ 65535。</p>
...
14. 单击“下一步”，进入“返回结果基础定义”页面，填写如[表8](#zh-cn_topic_0080101678_table744813380582)所示信息。
