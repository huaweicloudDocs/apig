...
-   **简单跨域访问**
    ...
    **图 1**  支持跨域<a name="fig4602042336"></a>  
...
-   **非简单请求的跨域访问**
    ...
    1.  在API的基本信息中，安全认证选“无认证”。
        ...
        **图 2**  预检请求-使用无认证方式<a name="fig24421049349"></a>  
    ...
    2.  定义API请求时，参数填写说明如下：
        ...
        **图 3**  预检请求-定义API请求<a name="fig196891157181014"></a>  
        ![](figures/预检请求-定义API请求.png "预检请求-定义API请求")

    3.  后端服务选择Mock

        **图 4**  预检请求-后端选Mock<a name="fig5918359955"></a>  
...
**图 5**  跨域访问<a name="fig7411102051912"></a>  
