...
5.  单击“新建API”，进入“新建API”页面，填写如[表1](#table195413315428)所示信息。
    ...
    **表 1**  基本信息
    ...
    <tr id="row14879114316433"><td class="cellrowborder" valign="top" width="18%" headers="mcps1.2.4.1.1 "><p id="p12880154304320"><a name="p12880154304320"></a><a name="p12880154304320"></a>所属分组</p>
    </td>
    <td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.4.1.2 "><p id="p48801043134312"><a name="p48801043134312"></a><a name="p48801043134312"></a>API所属分组。</p>
    </td>
    <td class="cellrowborder" valign="top" width="42%" headers="mcps1.2.4.1.3 "><p id="p8880154374314"><a name="p8880154374314"></a><a name="p8880154374314"></a>如果尚未创建API分组，单击“新建分组”，为API新创建一个分组。</p>
    </td>
    </tr>
...
6.  单击“下一步”，进入“定义API请求”页面，填写如[表2](#table197931223191513)所示信息。
    ...
    **表 2**  定义API请求
    ...
    <tbody><tr id="row197932236152"><td class="cellrowborder" valign="top" width="18%" headers="mcps1.2.4.1.1 "><p id="p9793132319151"><a name="p9793132319151"></a><a name="p9793132319151"></a>域名</p>
    </td>
    <td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.4.1.2 "><p id="p8793182315151"><a name="p8793182315151"></a><a name="p8793182315151"></a>域名。</p>
    </td>
    <td class="cellrowborder" valign="top" width="42%" headers="mcps1.2.4.1.3 "><p id="p187934232156"><a name="p187934232156"></a><a name="p187934232156"></a>默认分配的一个子域名。</p>
    </td>
    </tr>
    <tr id="row1579302341513"><td class="cellrowborder" valign="top" width="18%" headers="mcps1.2.4.1.1 "><p id="p14793172319157"><a name="p14793172319157"></a><a name="p14793172319157"></a>请求协议</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="42%" headers="mcps1.2.4.1.3 "><p id="p1179462313159"><a name="p1179462313159"></a><a name="p1179462313159"></a>传输重要或敏感数据时推荐使用HTTPS。</p>
    </td>
    </tr>
    ...
    <a name="ul15794115565"></a><a name="ul15794115565"></a><ul id="ul15794115565"><li>{}中的内容区分大小写。</li><li>请求Path中包含请求参数时，必须设置对应的入参定义。</li></ul>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="42%" headers="mcps1.2.4.1.3 "><a name="ul134522715211"></a><a name="ul134522715211"></a><ul id="ul134522715211"><li>选择绝对匹配，则调用的请求Path固定为创建时填写的API请求Path。</li><li>选择前缀匹配，则调用的请求Path将以创建时填写的API请求Path为前缀，支持接口定义多个不同Path。<div class="p" id="p25930366521"><a name="p25930366521"></a><a name="p25930366521"></a>例如，请求路径为/test/AA，使用前缀匹配时，通过/test/AA/CC可以访问，但是通过/test/AACC无法访问。<div class="note" id="note4911427135214"><a name="note4911427135214"></a><a name="note4911427135214"></a><span class="notetitle"> 说明： </span><div class="notebody"><p id="p2911172715219"><a name="p2911172715219"></a><a name="p2911172715219"></a>前缀匹配不支持“+”字符。</p>
    </div></div>
    </div>
    </li></ul>
    </td>
    ...
    <tr id="row19149171881810"><td class="cellrowborder" valign="top" width="18%" headers="mcps1.2.4.1.1 "><p id="p21502182182"><a name="p21502182182"></a><a name="p21502182182"></a>支持CORS</p>
    </td>
...
7.  （可选）设置入参定义。
    ...
    2.  输入如[表3](#table87021501869)所示信息。
        ...
        **表 3**  入参定义
        ...
        <td class="cellrowborder" valign="top" width="80%" headers="mcps1.2.3.1.2 "><p id="p13700140765"><a name="p13700140765"></a><a name="p13700140765"></a>字段的类型，包含String和Number。参数在“PATH”位置时，无需选择类型。</p>
        </td>
        </tr>
...
9.  单击“下一步”，进入“定义后端服务”页面。
    ...
    选择API后端服务类型。后端服务类型分HTTP/HTTPS、FunctionGraph和Mock三种，具体参数描述见[表4](#table19365277271)。
...
10. （可选）添加后端策略。
    ...
    2.  后端策略增加的参数，具体如[表5](#table161651642172215)所示，其他参数说明参见[表4](#table19365277271)。
        ...
        **表 6**  策略条件
        ...
        <table><thead align="left"><tr id="row16240858165410"><th class="cellrowborder" valign="top" width="20.59%" id="mcps1.2.3.1.1"><p id="p10240165817543"><a name="p10240165817543"></a><a name="p10240165817543"></a>信息项</p>
        </th>
        <th class="cellrowborder" valign="top" width="79.41%" id="mcps1.2.3.1.2"><p id="p19240125815419"><a name="p19240125815419"></a><a name="p19240125815419"></a>描述</p>
        </th>
        </tr>
        </thead>
        <tbody><tr id="row14240175855413"><td class="cellrowborder" valign="top" width="20.59%" headers="mcps1.2.3.1.1 "><p id="p162405589548"><a name="p162405589548"></a><a name="p162405589548"></a>条件来源</p>
        </td>
        <td class="cellrowborder" valign="top" width="79.41%" headers="mcps1.2.3.1.2 "><a name="ul824095855419"></a><a name="ul824095855419"></a><ul id="ul824095855419"><li>源地址：以访问API的请求地址作为策略条件来源。</li><li>请求入参：以请求入参参数作为策略条件来源。</li></ul>
        </td>
        </tr>
        <tr id="row124095810545"><td class="cellrowborder" valign="top" width="20.59%" headers="mcps1.2.3.1.1 "><p id="p1224085815417"><a name="p1224085815417"></a><a name="p1224085815417"></a>参数名称</p>
        </td>
        <td class="cellrowborder" valign="top" width="79.41%" headers="mcps1.2.3.1.2 "><p id="p20240658125416"><a name="p20240658125416"></a><a name="p20240658125416"></a>仅在“条件来源”为“请求入参”时，需要设置。选择已创建的入参参数名称。</p>
        </td>
        </tr>
        <tr id="row16241195813548"><td class="cellrowborder" valign="top" width="20.59%" headers="mcps1.2.3.1.1 "><p id="p10240125816544"><a name="p10240125816544"></a><a name="p10240125816544"></a>条件类型</p>
        </td>
        <td class="cellrowborder" valign="top" width="79.41%" headers="mcps1.2.3.1.2 "><p id="p13240125885416"><a name="p13240125885416"></a><a name="p13240125885416"></a>仅在“条件来源”为“请求入参”时，需要设置。</p>
        ...
        <tr id="row62411958195412"><td class="cellrowborder" valign="top" width="20.59%" headers="mcps1.2.3.1.1 "><p id="p19241115865413"><a name="p19241115865413"></a><a name="p19241115865413"></a>条件值</p>
        </td>
        <td class="cellrowborder" valign="top" width="79.41%" headers="mcps1.2.3.1.2 "><a name="ul102411958125415"></a><a name="ul102411958125415"></a><ul id="ul102411958125415"><li>“条件类型”为“相等”时，输入一个值。</li><li>“条件类型”为“枚举”时，输入多个值，以英文逗号隔开。</li><li>“条件类型”为“匹配”时，输入一个范围，例如：[0-5]。</li><li>“条件来源”为“源地址”时，输入一个或多个IP地址，以英文逗号隔开。</li></ul>
        </td>
        </tr>
        </tbody>
        </table>
...
11. （可选）配置后端服务参数。
    ...
    2.  根据后端服务实际的参数名称和参数位置修改映射关系，如[图1](#fig138502167331)所示。

        **图 1**  配置后端服务参数<a name="fig138502167331"></a>  
...
12. （可选）设置常量参数。
    ...
    2.  单击“添加常量参数”，输入如[表7](#table1835918141595)所示信息。
        ...
        **表 7**  常量参数
        ...
        <table><thead align="left"><tr id="row43581714193"><th class="cellrowborder" valign="top" width="30.3%" id="mcps1.2.3.1.1"><p id="p163583143913"><a name="p163583143913"></a><a name="p163583143913"></a>信息项</p>
        </th>
        <th class="cellrowborder" valign="top" width="69.69999999999999%" id="mcps1.2.3.1.2"><p id="p335881412912"><a name="p335881412912"></a><a name="p335881412912"></a>描述</p>
        </th>
        </tr>
        </thead>
        <tbody><tr id="row535818141391"><td class="cellrowborder" valign="top" width="30.3%" headers="mcps1.2.3.1.1 "><p id="p635816141094"><a name="p635816141094"></a><a name="p635816141094"></a>常量参数名</p>
        </td>
        <td class="cellrowborder" valign="top" width="69.69999999999999%" headers="mcps1.2.3.1.2 "><p id="p193581148918"><a name="p193581148918"></a><a name="p193581148918"></a>常量参数的名称，如果参数在“PATH”位置，那么参数名称需要和“后端请求Path”中的名称相同。</p>
        ...
        <tr id="row135851411919"><td class="cellrowborder" valign="top" width="30.3%" headers="mcps1.2.3.1.1 "><p id="p153589140914"><a name="p153589140914"></a><a name="p153589140914"></a>参数位置</p>
        </td>
        <td class="cellrowborder" valign="top" width="69.69999999999999%" headers="mcps1.2.3.1.2 "><p id="p435810141397"><a name="p435810141397"></a><a name="p435810141397"></a>选择参数在请求中的位置。</p>
        <p id="p1935811141599"><a name="p1935811141599"></a><a name="p1935811141599"></a>参数位置有如下三种：PATH、QUERY、HEADER</p>
        </td>
        </tr>
        <tr id="row1935841420916"><td class="cellrowborder" valign="top" width="30.3%" headers="mcps1.2.3.1.1 "><p id="p133581614392"><a name="p133581614392"></a><a name="p133581614392"></a>参数值</p>
        </td>
        <td class="cellrowborder" valign="top" width="69.69999999999999%" headers="mcps1.2.3.1.2 "><p id="p83581914693"><a name="p83581914693"></a><a name="p83581914693"></a>输入参数的值。</p>
        </td>
        </tr>
        <tr id="row12358131417915"><td class="cellrowborder" valign="top" width="30.3%" headers="mcps1.2.3.1.1 "><p id="p123586141299"><a name="p123586141299"></a><a name="p123586141299"></a>描述</p>
        </td>
        <td class="cellrowborder" valign="top" width="69.69999999999999%" headers="mcps1.2.3.1.2 "><p id="p1135818143910"><a name="p1135818143910"></a><a name="p1135818143910"></a>对于此常量参数的描述。</p>
        </td>
        </tr>
        </tbody>
        </table>
...
13. 单击“下一步”，进入“返回结果基础定义”页面，填写如[表8](#table744813380582)所示信息。
