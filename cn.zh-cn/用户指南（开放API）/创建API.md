...
6.  单击“新建API”，进入“新建API”页面，如[图1](#fig59892196141)所示。填写如[表1](#table195413315428)所示信息。
    ...
    **表 1**  基本信息
    ...
    <tr id="row198013182315"><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.3.1.1 "><p id="p138017188311"><a name="p138017188311"></a><a name="p138017188311"></a>网关响应</p>
    </td>
    <td class="cellrowborder" valign="top" width="80%" headers="mcps1.2.3.1.2 "><p id="p480141812320"><a name="p480141812320"></a><a name="p480141812320"></a>网关响应指API网关未能成功处理API请求，从而产生的错误响应。</p>
    ...
    <tr id="row48673328315"><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.3.1.1 "><p id="p2086720324318"><a name="p2086720324318"></a><a name="p2086720324318"></a>支持简易认证</p>
    </td>
    <td class="cellrowborder" valign="top" width="80%" headers="mcps1.2.3.1.2 "><p id="p1769917615481"><a name="p1769917615481"></a><a name="p1769917615481"></a>简易认证指APP认证方式下调用API时，在HTTP请求头部消息增加一个参数X-Apig-AppCode，而不需要对请求内容签名，API网关也仅校验AppCode，不校验请求签名，从而实现快速响应。</p>
    ...
    <tr id="row3902017219"><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.3.1.1 "><p id="p179120142119"><a name="p179120142119"></a><a name="p179120142119"></a>自定义认证</p>
    </td>
    <td class="cellrowborder" valign="top" width="80%" headers="mcps1.2.3.1.2 "><p id="p4916017212"><a name="p4916017212"></a><a name="p4916017212"></a>自定义认证需要提前创建，可单击右侧的“新建自定义认证”链接创建。</p>
    </td>
    </tr>
    <tr id="row2113124794715"><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.3.1.1 "><p id="p18113247164716"><a name="p18113247164716"></a><a name="p18113247164716"></a>标签</p>
    </td>
    <td class="cellrowborder" valign="top" width="80%" headers="mcps1.2.3.1.2 "><p id="p9113747134716"><a name="p9113747134716"></a><a name="p9113747134716"></a>标签主要用于对API添加分类属性，方便在创建了大量API后，快速过滤和查找。</p>
    </td>
    </tr>
...
2.  （可选）设置入参定义。
    ...
    2.  输入如[表3](#table87021501869)所示信息。
        ...
        **表 3**  入参定义
        ...
        <td class="cellrowborder" valign="top" width="79.96%" headers="mcps1.2.3.1.2 "><p id="p15700401369"><a name="p15700401369"></a><a name="p15700401369"></a>选择参数在请求中的位置。</p>
...
1.  定义默认后端。
    ...
    **图 5**  添加自定义认证<a name="fig787955717539"></a>  
...
2.  （可选）添加后端策略。
    ...
    2.  后端策略增加的参数，具体如[表5](#table161651642172215)所示，其他参数说明参见[表4](#table19365277271)。
        ...
        **图 6**  后端策略新增参数<a name="fig13882182964017"></a>  
...
3.  （可选）配置后端服务参数。
    ...
    2.  根据后端服务实际的参数名称和参数位置修改映射关系，如[图7](#fig138502167331)所示。

        **图 7**  配置后端服务参数<a name="fig138502167331"></a>  
...
4.  （可选）设置常量参数。
    ...
    2.  单击“添加常量参数”，输入如[表7](#table1835918141595)所示信息。
        ...
        **图 8**  添加常量参数<a name="fig49610214320"></a>  
